...
$inner_section_border_top_left_radius = get_field('inner_section_border_top_left_radius');
$inner_section_border_top_right_radius = get_field('inner_section_border_top_right_radius');
$inner_section_border_bottom_left_radius = get_field('inner_section_border_bottom_left_radius');
$inner_section_border_bottom_right_radius = get_field('inner_section_border_bottom_right_radius');

?>
<?php if($use_bg) { ?>
<div class="il_block_bg" style="<?= $blue_gradient ? 'background: radial-gradient(50% 50.00% at 50% 50.00%, #144A9D 0%, #132051 100%);' : 'background-color: ' . $bg_color . ';' ?> <?php echo 'border-top-left-radius: ' . $inner_section_border_top_left_radius . 'px; border-top-right-radius: ' . $inner_section_border_top_right_radius . 'px; border-bottom-left-radius: ' . $inner_section_border_bottom_left_radius . 'px; border-bottom-right-radius: ' . $inner_section_border_bottom_right_radius . 'px; '?>">
